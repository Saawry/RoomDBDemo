...
public class AddStudent extends AppCompatActivity {
    ...
    private void InsertNewStudent() {
        Call<ResponseBody> call = RetrofitClient.getInstance().getApi().AddNewStudent(studentId,
                studentRoll, admissionDate, DateOfBirth, ShiftId, classId, sectionId, imageName,
                createdTime, createdBy, status, Guardian_Phone, Relation);
